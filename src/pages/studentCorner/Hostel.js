  ...
  const circulars = [
    {
      SNO: "2024WEB0232",
      Date: "28/02/24",
      Title: "Dash Derby Result",
      Link: "https://www.ecajmer.ac.in/Content/Orders/CAS/Files/2024WEB0232-28-02-24-Result_Dash_Derby_Sprint_competition_AKAM_Feb_Activity_-_Copy[1]-vpEduQ.doc",
    },
    {
      SNO: "2024WEB0224",
      Date: "26/02/24",
      Title: "Sprint Competition Under AKAM",
      Link: "https://www.ecajmer.ac.in/Content/Orders/CAS/Files/2024WEB0232-28-02-24-Result_Dash_Derby_Sprint_competition_AKAM_Feb_Activity_-_Copy[1]-vpEduQ.doc",
    },
  ];
      ...
      >
        <Box sx={{ padding: "10px" }}>
          ...
          <CustomTabPanel value={value} index={1}>
            <MyTable
              data={Circulars}
              styles={{ width: "calc(100vw - 400px)" }}
            />
          </CustomTabPanel>
          <CustomTabPanel value={value} index={2}>
            <embed
              src="/Hostel_Manual.pdf"
            ...
            {/* <iframe
              src="https://ecajmer.ac.in/hostel/Hostel_Manual.pdf"
              width="500px"
              height="100px"
            /> */}
          </CustomTabPanel>
