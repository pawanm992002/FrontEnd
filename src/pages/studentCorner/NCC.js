            ...
            >
                <Box sx={{ padding: '10px' }}>
                    ...
                    <CustomTabPanel value={value} index={0}>
                        <Typography>
                            The National Cadet Corps plays a significant part in molding a person's character. It fosters the spirit of teamwork and man-management and leads to the development of a more pleasing overall personality.
                        </Typography>
                        <Box>
                            ...
                            <ol style={{ display: 'flex', gap: '10px', flexDirection: 'column', paddingLeft: '15px', marginTop: '10px' }}>
                                <li>To channelize the energy and dynamism of young men towards activities beneficial to them and to the society.</li>
                                <li>Constructive use of leisure time, wholesome recreation, wide cultural sympathies, abiding social consciousness and an alert mind.</li>
                                <li>Recognizing the importance of the NCC, the Institute offers the students an opportunity to be part of the NCC. The Institute has strength of 100 cadets. All the incoming students who had opted for NCC are required to enroll themselves in the first year for 3-Year course. The Institute cadets are part of the 2-Rajasthan Engineer Coy. NCC Ajmer.</li>
                            </ol>
                        </Box>
                        <Box>
                            <Typography variant='h5' marginY='10px'>
                            ...
                            <Typography>Various social activities are also organized to encourage the feeling of belonging to the society.
                            </Typography>
                            <ol style={{ display: 'flex', gap: '10px', flexDirection: 'column', paddingLeft: '15px', marginTop: '10px' }}>
                    ...
                    <CustomTabPanel value={value} index={3}>
                        ...
                        <Box>
                            ...
                            <ol style={{ display: 'flex', gap: '10px', flexDirection: 'column', paddingLeft: '15px', marginTop: '10px' }}>
                                <li>An Annual Training Camp is held to further enhance and inculcate a feeling of independence in the cadets.</li>
                                <li>Extensive knowledge about devices used in the Army like mines, bridges, nuclear and biological weapons etc. is imparted.</li>
                                <li>Self defense training is also given.</li>
                                <li>Rigorous physical training is provided in the camp with a view to increasing the physical endurance of the cadets.</li>
                                <li>Military training with rifles is also provided.</li>
                                <li>Cultural programmers are also held with a view to improving the cultural and social outlook of the cadets.</li>
                            </ol>
                        </Box>
                    </CustomTabPanel>
