import { AddAPhoto, AppRegistration, BuildTwoTone, DashboardSharp, IceSkating, RequestQuote, Settings } from "@mui/icons-material";
...
export default function Alumni() {
  ...
  const ClickHandeller = (data) => {
    ...
    const members = [
      {"S.No":1,Date:"20/10/19",Title:"Feedback Form for ECA Alumni Memorandum Draft",Link:"View"},
      {"S.No":2,Date:"20/10/19",Title:"Feedback Form for ECA Alumni Memorandum Draft",Link:"View"},
      {"S.No":3,Date:"20/10/19",Title:"Feedback Form for ECA Alumni Memorandum Draft",Link:"View"},
      {"S.No":4,Date:"20/10/19",Title:"Feedback Form for ECA Alumni Memorandum Draft",Link:"View"},
      {"S.No":5,Date:"20/10/19",Title:"Feedback Form for ECA Alumni Memorandum Draft",Link:"View"},
  ]
  ...
  return (
    ...
    <Box sx={{ width: "80%", margin: "auto",position:'relative' }}>
      ...
      {ActiveBox == 1 ? (
       ...
       <Box sx={{m:'10px 0'}}> <MyTable data={rows}/> </Box>
      ) : (
        <Box sx={{m:'10px 0'}}>
        ...
        <Box 
          ...
          sx={{position:"absolute",bottom:10,right:-130,borderRadius:'50%',width:'50px',height:'50px',bgcolor:'#213153EB',color:'white',zIndex:6,display:'flex',alignItems:'center',justifyContent:'center'}}
      ...
      { Toggle && 
        ...
        <Box><Tooltip title="Distinguished Alumni" placement="right"><IceSkating/></Tooltip>  </Box>
        <Box><Tooltip  title="Registration" placement="right"> <AppRegistration/></Tooltip></Box>
        <Box> <Tooltip  title="Appeal To Alumni" placement="right"> <RequestQuote/></Tooltip> </Box>
        </Box>
      }
    </Box>
    <ModalComponent/>
