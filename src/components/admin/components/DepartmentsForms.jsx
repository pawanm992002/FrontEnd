...
export const FacultyMemberForm = () => {
    const [form,setForm] = useState({name:'',email:'',password:'',designation:'',roomNo:'',department:'',profile:''});
        ...
        <FormBox title={"Add New faculty"} >
            <form onSubmit={handleSubmit}>
                <VStack spacing={4}>
                    ...
                    <FormInputBox label={"Faculty Name"} name={'name'} placeholder={"John Doe"} value={form.name} handleChange={handleChange} />

                    <FormInputBox label={"Faculty Email"} name={'email'} type='email' placeholder={"johndoe23@gmail.com"} value={form.email} handleChange={handleChange} />

                    <FormInputBox label={"Faculty Password"} name={'password'} type='password' placeholder={"johndoe23@gmail.com"} value={form.password} handleChange={handleChange} />

                    <FormInputBox label={'Faculty Profile'} type='file' handleChange={handleFileChange} name={'profile'} />

                    <FormInputBox label={"Faculty Department"} name={'department'} placeholder={"CSE"} value={form.department} handleChange=
                    {handleChange} />

                    <FormInputBox label={"Faculty Designation"} name={'designation'} placeholder={"HOD"} value={form.designation} handleChange={handleChange} />

                    <FormInputBox label={"Faculty RoomNo."} name={'roomNo'} placeholder={"C-7"} value={form.roomNo} handleChange={handleChange} />
        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <VStack spacing={4}>
                    ...
                    <FormInputBox label={"Upload Timetable"} type='file' name={'timetable'} handleChange={handleFileChange} />
